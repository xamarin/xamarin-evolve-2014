...
namespace Touch.iOS.ViewControllers
{
    public class SimpleTouch : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            lblNumberOfFingers.Frame = new RectangleF(10, 400, View.Frame.Width, 44.0f);

            lblTouchStatus = new UILabel();
            lblTouchStatus.Text = "Touch Status:";
            lblTouchStatus.Frame = new RectangleF(10, 100, View.Frame.Width, 44.0f);
		...
		#region Step 1 - Ensure we can have user interaction and multiple touches enabled
		...
		#region Step 2 - Subscribe to touches began events
        ...
        public override void TouchesBegan(NSSet touches, UIEvent evt)
        {
			...
			#region Step 3 - Check if touch was on a particular view
			...
			#region Step 4 - Detect multiple taps
		...
		#region Step 5 - Listen for cancelled touches
		...
		#region Step 7 - Listen for moved touches
		...
		#region Step 8 - Listen for ended touches
