...
namespace com.xamarin.university.mobilenav.android.actionbartabs
{
	internal class AnimalListFragment : ListFragment
	{
		...
		public override void OnActivityCreated (Bundle savedInstanceState)
		{
			...
			var adapter = new ArrayAdapter<String> (Activity, Android.Resource.Layout.SimpleListItem1, EvolveData.AnimalData.Select (e => e.Name).ToArray ());
			ListAdapter = adapter;
		...
		private void ShowDetails (int animalId)
		{
			...
			var details = AnimalDetailsFragment.NewInstance (animalId);
