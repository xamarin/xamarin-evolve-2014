...
{
	public class SpeakersAdapter: BaseAdapter<Animal>, ISectionIndexer
	{
		...
		public override View GetView (int position, View convertView, ViewGroup parent)
		{
			...
			var speakerNameView = view.FindViewById<TextView> (Resource.Id.animalNameTextView);
			speakerNameView.Text = speaker.Name;
			
			var speciesNameTextView = view.FindViewById<TextView> (Resource.Id.speciesNameTextView);
			speciesNameTextView.Text = speaker.Species;
